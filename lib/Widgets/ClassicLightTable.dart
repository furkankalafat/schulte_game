...
class ClassicLightTable extends StatefulWidget {
  final int index;
  ...
  @override
  _ClassicLightTableState createState() => _ClassicLightTableState();
}

class _ClassicLightTableState extends State<ClassicLightTable> {
  bool selected;
  Timer _everySecond;
