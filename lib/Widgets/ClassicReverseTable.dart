...
class ClassicReverseTable extends StatefulWidget {
  final int index;
  ...
  @override
  _ClassicReverseTableState createState() => _ClassicReverseTableState();
}

class _ClassicReverseTableState extends State<ClassicReverseTable> {
  bool selected;
  Timer _everySecond;
